...
#     python immune_inf/preprocess.py --wsi_path "/work/$username/liver_portal/wsi/test/$case_name.$ext" \
#                          --pkl_path "/work/$username/Cluster_Immune/pkl/$case_name.pkl" \
#                          --segment_output_dir "/work/$username/Cluster_Immune/tissue_png_imgs" \
...
#     python inf_portal+tissue.py --wsi_path "/work/$username/liver_portal/wsi/test/$case_name.$ext" \
#         --patch_size 512 \
...
#         --output_dir "/work/$username/Cluster_Immune/inference_result"
    ...
    python immune_inf/Inference.py --wsi_path "/work/$username/liver_portal/wsi/test/$case_name.$ext" \
                        --pkl_path "/work/$username/Cluster_Immune/pkl/$case_name.pkl" \
                        --inference_dir "/work/$username/Cluster_Immune/inference_result" \
...
#     python calculate_clust_immune.py --immune_map "/work/$username/Cluster_Immune/inference_result/${case_name}_immune_binary.png" \
