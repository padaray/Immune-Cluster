...
#     print("Data Load Success!")
    ...
    # 將 global_mask 依據實際倍率縮小至 10x 大小
    target_mag = 10.0
    downsample_factor = actual_patch_mag / target_mag
    H3 = int(global_mask.shape[0] / downsample_factor)
    W3 = int(global_mask.shape[1] / downsample_factor)
    ...
    # 6. 疊加 global_mask_resized 到原圖縮圖 ====================
...
#     w, h = slide_os.level_dimensions[level_used]
    ...
    target_mag = 10.0
    downsample_factor = actual_patch_mag / target_mag
    h = int(global_mask.shape[0] / downsample_factor)
    w = int(global_mask.shape[1] / downsample_factor)
